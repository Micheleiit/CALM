...
- Scrematura dei nodi attraverso il settaggio di una distanza euclidea minima (MIN_EUCLID_DIST) !!!! SISTEMARE IL RETURN CON UN FLAG !!!!
- Adattamento dinamico dell'incremento di pointX in base alla distanza tra i nodi. Se due nodi sono molto distanti, 	uso un incremento maggiore, mentre se sono più vicini, riduco l'incremento (DA IMPLEMENTARE)
