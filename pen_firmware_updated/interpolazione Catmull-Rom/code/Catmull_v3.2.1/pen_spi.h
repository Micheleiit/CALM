...
#define MOVING_AVG_BUFFER_SIZE  10   // filtro a media mobile 
...
void optimizeData(SPIStruct* spiStruct); // filtra gli outliers
void deleteNoise(SPIStruct* spiStruct);  // filtra le piccole oscillazioni
/**************************************************************************************************************************************/
