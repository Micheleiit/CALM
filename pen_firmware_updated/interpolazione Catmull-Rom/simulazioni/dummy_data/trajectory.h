...
// Lasts approx 25 sec
#define TRAJECTORY_MAX_SIZE 100 // 2500
#define STREAMING_PERIOD_ms 1
#define INTERPOLATION_DENSITY 0.25 // fattore pari a 1/N dove N è il numero di punti intermedi su cui calcolare l'interpolazione fra una coppia di nodi
/**************************************************************************************************************************************/
