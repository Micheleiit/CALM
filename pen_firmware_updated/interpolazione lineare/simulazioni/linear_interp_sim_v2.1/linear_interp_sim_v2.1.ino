...
void loop() {
  ...
  if(current_state == RECORDING){
    ...
    if (currentIteration < TRAJECTORY_MAX_SIZE && i < sizeof(simulatedDataX)/sizeof(simulatedDataX[0])) {
      ...
      //traj_record->current_index = traj_record->current_index_record;
      traj_record->current_index = traj_record->current_size - 1;
      Serial.println("draw");
      Serial.print("current_index:");
      Serial.print(traj_record->current_index);
      Serial.print(",current_size:");
      Serial.println(traj_record->current_size);
